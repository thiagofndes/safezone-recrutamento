...
st.markdown("""
    <style>
        ...
        .banner {
            width: 100vw;
            height: 40vh;
            background-image: url('https://github.com/thiagofndes/safezone-recrutamento/blob/main/images/BVANNER.png?raw=true');
        ...
        /* Ícone Discord pequeno e centralizado */
        .discord-link {
            text-align: center;
            margin-top: 2rem;
        }
...
# Sobre a Guilda (fixo, sem expander)
st.markdown('<div id="sobre" class="sobre">', unsafe_allow_html=True)
...
st.markdown("""
    <div style="text-align:center; margin:2rem 0; color:gray; font-size:0.8rem;">
